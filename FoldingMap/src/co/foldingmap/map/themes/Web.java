 ...
 * @author Alec
 */
public class Web extends MapTheme {
    ...
    public Web() {
        ...
        addStyleElement(new PolygonStyle("Country - No Fill",     new Color(200, 200, 200, 128), ThemeConstants.LAND, false));
        ...
        addStyleElement(new PolygonStyle("Small Island",          new Color(239, 237, 230), new Color(239, 237, 230, 140), ThemeConstants.LAND));
