 ...
 * @author Alec
 */
public class MoveSelectedLayerDown extends Action {
    private ArrayList<Layer>    layers;
    private int                 originalIndex;
    private Layer               selectedLayer;
    
    public MoveSelectedLayerDown(DigitalMap mapData) {
        this.commandDescription = "Move Selected Layer Down";
